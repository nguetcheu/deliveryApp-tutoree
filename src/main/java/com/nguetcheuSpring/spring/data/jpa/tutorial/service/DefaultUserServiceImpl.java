...
import com.nguetcheuSpring.spring.data.jpa.tutorial.repository.RoleRepository;
...
public class DefaultUserServiceImpl implements DefaultUserService {
   ...
   @Autowired
	...
	public User save(UserRegisteredDTO userRegisteredDTO) {
		...
		else if (userRegisteredDTO.getRole().equals("STAFF"))
			role = roleRepo.findByRole("STAFF");
